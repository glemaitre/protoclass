"""PUN quantification extraction from temporal modality."""
...
def _PUN_model(t, a0=2., r=1., beta=1.):
    """PUN model to compute the concentration.
...
def _fit_PUN_model(t_mod, s_t, S0, init_params):
...
class PUNQuantificationExtraction(TemporalExtraction):
    ...
    def __init__(self, base_modality, random_state=None):
        super(PUNQuantificationExtraction, self).__init__(base_modality)
    ...
    def fit(self, modality, ground_truth=None, cat=None):
        ...
        """
        super(PUNQuantificationExtraction, self).fit(
            modality=modality,
    ...
    def transform(self, modality, ground_truth=None, cat=None):
        ...
        data : ndarray, shape (n_sample, n_feature)
            ...
            The feature will be the following (a0, r, beta)

        """
        super(PUNQuantificationExtraction, self).transform(
            modality=modality,
            ground_truth=ground_truth,
            cat=cat)
