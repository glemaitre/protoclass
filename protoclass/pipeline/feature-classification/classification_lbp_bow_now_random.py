...
if (count_gt[0] != count_gt[1]):
    ...
    codebook_filename = '/work/le2i/gu5306le/OCT/lbp_r_' + str(radius) + '_hist_now_codebook_random/codebook.pkl'
    ...
    path_to_save = '/work/le2i/gu5306le/OCT/lbp_r_' + str(radius) + '_hist_BoW_now_random_results'
